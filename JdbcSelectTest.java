   ...
   public static void main(String[] args) {
      try (
         ...
         Connection conn = DriverManager.getConnection(
               "jdbc:mysql://localhost:3306/db_testing?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
               "root", "classproject4");   // For MySQL only
         ...
         String strSelect = "select a_name from agent";
         ...
         while(rset.next()) {   // Repeatedly process each row
            String name = rset.getString("a_name");  // retrieve a 'String'-cell in the row
