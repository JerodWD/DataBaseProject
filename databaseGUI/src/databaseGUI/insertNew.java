...
public class insertNew {
	...
	public static void insertNewData(){
		...
		JFrame addData = new JFrame("Insert New " + Runner.currentTable);
		...
		//frame used for pop out windows saying various errors
		Component frame = null;

		if(Runner.currentTable == "CUSTOMER") 
		{
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					//add checks to make sure primary key is unique and foreign key matches existing keys
					try(
						...
						Runner.secondWindow.setVisible(true);
					}
					catch(SQLException q) {

						if(CUST_ID.equals("") || CUST_FNAME.equals("") || CUST_LNAME.equals("") || CUST_ADDRESS.equals("") || CUST_CITY.equals("") || CUST_STATE.equals("") || CUST_ZIP.equals("") 
								|| CUST_PHONENUM.equals("") || CUST_SEATNUM.equals("") || CUST_AGE.equals("") || FLIGHT_NUM.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if (Runner.currentTable == "Plane")
		{
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try(
						...
						if(PLANE_ID.equals("") || CAP_ID.equals("") || BUS_CLS_CAP.equals("") || ECO_CLAS_CAP.equals("") || FIRST_CLASS_CAP.equals("") || PLANE_MODEL.equals("") || ATT_ID.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if(Runner.currentTable == "Flight")
		{
			JLabel L_FLIGHT_NUM = new JLabel("Flight Number: ");
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try(
						...
						if(FLIGHT_NUM.equals("") || FLIGHT_DATE.equals("") || ROUTE_ID.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if(Runner.currentTable == "Route")
		{
			JLabel L_ROUTE_ID = new JLabel("Route ID: ");
			JLabel L_DEP_LOC = new JLabel("Departure Location: ");
			JLabel L_ARR_LOC = new JLabel("Arrival Location: ");
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try(
						...
						if(ROUTE_ID.equals("") || DEP_LOC.equals("") || ARR_LOC.equals("") || PORT_ID.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if(Runner.currentTable == "Airport")
		{
			JLabel L_PORT_ID = new JLabel("Port ID: ");
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					String strInsert = "INSERT INTO airport VALUES (" + PORT_ID + ", \"" + PORT_NAME + "\", \"" + PORT_CITY + "\", \"" + PORT_COUNTRY + "\", " + PORT_LAT + ", " + PORT_LONG + ", \"" + PORT_TIMEZONE + "\");";
					//execute query
					try(
							Connection conn = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/flight manager?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
						...
						if(PORT_ID.equals("") || PORT_NAME.equals("") || PORT_CITY.equals("") || PORT_COUNTRY.equals("") || PORT_LAT.equals("") || PORT_LONG.equals("") || PORT_TIMEZONE.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if(Runner.currentTable == "Flight_attendant")
		{
			...
			addData.add(L_ATT_ID);
			addData.add(L_ATT_FNAME);
			addData.add(L_ATT_LNAME);
			addData.add(L_ATT_ADDRESS);
			addData.add(L_ATT_STATE);
			addData.add(L_ATT_CITY);
			addData.add(L_ATT_ZIP);
			addData.add(L_ATT_PHPNENUM);
			addData.add(L_ATT_AGE);

			// add text boxes to the frame
			addData.add(TXT_ATT_ID);
			addData.add(TXT_ATT_FNAME);
			addData.add(TXT_ATT_LNAME);
			addData.add(TXT_ATT_ADDRESS);
			addData.add(TXT_ATT_STATE);
			addData.add(TXT_ATT_CITY);
			addData.add(TXT_ATT_ZIP);
			addData.add(TXT_ATT_PHPNENUM);
			addData.add(TXT_ATT_AGE);
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try(
						...
						if(ATT_ID.equals("") || ATT_FNAME.equals("") || ATT_LNAME.equals("") || ATT_ADDRESS.equals("") || ATT_STATE.equals("") || ATT_CITY.equals("") || ATT_ZIP.equals("")
								|| ATT_PHPNENUM.equals("") || ATT_AGE.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
		...
		else if(Runner.currentTable == "Captain")
		{
			JLabel L_CAP_ID = new JLabel("Captain ID: ");
			...
			addData.add(L_CAP_ID);
			addData.add(L_CAP_FNAME);
			addData.add(L_CAP_LNAME);
			addData.add(L_CAP_ADDRESS);
			addData.add(L_CAP_STATE);
			addData.add(L_CAP_CITY);
			addData.add(L_CAP_ZIP);
			addData.add(L_CAP_PHPNENUM);
			addData.add(L_CAP_AGE);

			// add text boxes to the frame
			addData.add(TXT_CAP_ID);
			addData.add(TXT_CAP_FNAME);
			addData.add(TXT_CAP_LNAME);
			addData.add(TXT_CAP_ADDRESS);
			addData.add(TXT_CAP_STATE);
			addData.add(TXT_CAP_CITY);
			addData.add(TXT_CAP_ZIP);
			addData.add(TXT_CAP_PHPNENUM);
			addData.add(TXT_CAP_AGE);
			...
			submit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					String strInsert = "INSERT INTO captain VALUES (" + CAP_ID + ", \"" + CAP_FNAME + "\", \"" + CAP_LNAME + "\", \"" + CAP_ADDRESS + "\", \"" + CAP_STATE + "\", \"" + CAP_CITY + "\", " + CAP_ZIP + ", \"" + CAP_PHPNENUM + "\", " + CAP_AGE + ");";
					//execute query
					try(
							Connection conn = DriverManager.getConnection(
									"jdbc:mysql://localhost:3306/flight manager?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
						...
						if(CAP_ID.equals("") || CAP_FNAME.equals("") || CAP_LNAME.equals("") || CAP_ADDRESS.equals("") || CAP_STATE.equals("") || CAP_CITY.equals("") || CAP_ZIP.equals("")
								|| CAP_PHPNENUM.equals("") || CAP_AGE.equals("")) {
							JOptionPane.showMessageDialog(frame, "ERROR:  BOXES CANNOT BE EMPTY.", "Empty Box Error", JOptionPane.ERROR_MESSAGE);
						}
						else {
							JOptionPane.showMessageDialog(frame, "ERROR:  CONSISTENCY ERROR.  CHECK PRIMARY AND FOREIGN KEYS.", "Consistency Error", JOptionPane.ERROR_MESSAGE);
